            ...
            <Container fluid>
                <Row id="work-experience" className="row align-items-center">
                    ...
                    <Col className="col-md-9 col-sm-8 pl-5">
                        ...
                        <h2 className="work-heading">Software Development Engineer</h2>
                        <h3 className="work-heading">Vancouver, British Columbia &nbsp;&nbsp;&nbsp;&nbsp; Aug. 2022 - Present</h3>
                ...
                <Row id="work-experience" className="row align-items-center">
                    ...
                    <Col className="col-md-9 col-sm-8 pl-5">
                        ...
                        <h2 className="work-heading">Investment Banking Summer Analyst</h2>
                        <h3 className="work-heading">Toronto, Ontario &nbsp;&nbsp;&nbsp;&nbsp; May 2021 - Aug. 2021</h3>
                ...
                <Row id="work-experience" className="row align-items-center">
                    ...
                    <Col className="col-md-9 col-sm-8 pl-5">
                        ...
                        <h2 className="work-heading">Full Stack Developer Intern</h2>
                        <h3 className="work-heading">Montreal, Quebec &nbsp;&nbsp;&nbsp;&nbsp; Jun. 2020 - Aug. 2020</h3>
                ...
                <Row id="work-experience" className="row align-items-center">
                    ...
                    <Col className="col-md-9 col-sm-8 pl-5">
                        ...
                        <h2 className="work-heading">Chemical Engineering Intern</h2>
                        <h3 className="work-heading">Toronto, Ontario &nbsp;&nbsp;&nbsp;&nbsp; May 2019 - Sep. 2019</h3>
                ...
                <Row id="work-experience" className="row align-items-center">
                    ...
                    <Col className="col-md-9 col-sm-8 pl-5">
                        ...
                        <h2 className="work-heading">Process Plant Engineering Intern</h2>
                        <h3 className="work-heading">Rankin Inlet, Nunavut &nbsp;&nbsp;&nbsp;&nbsp; Jan. 2019 - May 2019</h3>
