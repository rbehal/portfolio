...
const awn = {
    ...
    description: 'At Arctic Wolf Networks, I am responsible for designing, deploying, and maintaining machine learning models in production, as well as ensuring their scalability, reliability, and efficiency. \
I utilize AWS services, like AWS Sagemaker, to develop and deploy machine learning models, optimize their performance, and manage the overall ML infrastructure. \
I am also constantly collaborating with data scientists, security analysts, and other software engineers to integrate ML models into the offered products and services, and to monitor their performance. \
In addition, I contribute to the development of ML pipelines, incorporating data preprocessing, feature engineering, and model evaluation, while ensuring data security and privacy compliance.',
    logo: awnLogo,
}
...
const amazon = {
    ...
    description: 'At Amazon, I worked within the Selling Partner Experience (SPX) organization to deliver products designed to maximize seller efficiency and minimize frustration. \
...
const scotiabank = {
    ...
    description: 'At Scotiabank, I worked within the Equity Capital Markets and Mining coverage groups dealing with both origination and execution services. \
...
const neat = {
    ...
    description: 'Neat aims to accelerate innovation in organizations and accelerate the training process through a software solution that reduces redundancies and streamlines \
...
const siemens = {
    ...
    description: 'I conducted observational analyses in order to update all of the procedures (SOPs) for the high voltage equipment manufacturing plant at Trench Group. I also \
...
const agnico = {
    ...
    description: 'Agnico Eagle Mines is one of the top gold mining companies in the country. I was responsible for developing operation and maintenance procedures (SOPs) \
...
export const workExperiences = [awn, amazon, scotiabank, neat, siemens, agnico];